        ...
        <View style={styles.modeRow}>
          {MODES.map((m) => (
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Ionicons name={m.icon} size={18} color={mode === m.id ? COLORS.primary : COLORS.textSecondary} />
...
const styles = StyleSheet.create({
  ...
  modeTabActive: { backgroundColor: COLORS.primaryLight, borderColor: COLORS.primary },
  ...
  inputLabel: { fontSize: FONT_SIZE.xs, fontWeight: '700', color: COLORS.textSecondary, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.8 },
  input: {
  ...
  imageLabel: { fontSize: FONT_SIZE.md, fontWeight: '700', color: COLORS.text },
  imageSub: { fontSize: FONT_SIZE.xs, color: COLORS.textTertiary },
  ...
  successText: { flex: 1, fontSize: FONT_SIZE.sm, color: COLORS.success, fontWeight: '600' },
  ...
  tipsTitle: { fontSize: FONT_SIZE.sm, fontWeight: '700', color: COLORS.text, marginBottom: SPACING.sm },
  tip: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, paddingVertical: 6 },
  tipText: { flex: 1, fontSize: FONT_SIZE.sm, color: COLORS.textSecondary, lineHeight: 20 },
});
